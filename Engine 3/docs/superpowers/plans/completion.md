...
- [x] 3 PASS — float governor correctly forces T3 over T2 when `v_float_exposure` is at/above `float_cap_usd`; null-cap (unset) correctly treated as unlimited
...
- [x] 7 PASS — T-16-adjacent regression suite green (807/817 pre-existing, zero T-27 regressions); zero changes to invoice creation or the POD-triggered invoice flow
